...
"color: white;"));
        ...
        verticalLayout_2 = new QVBoxLayout(PageLO);
...
"padding: 5px;"));
        ...
        verticalLayout_2->addLayout(headerLO);
...
""));
        ...
        pushButton = new QPushButton(PageLO);
...
"background-color: rgb(228, 215, 190);"));
        ...
        FilmLO->addWidget(pushButton);

        FilmLO->setStretch(0, 2);
        FilmLO->setStretch(1, 1);
        FilmLO->setStretch(2, 20);

        verticalLayout_2->addLayout(FilmLO);

        scrollArea = new QScrollArea(PageLO);
...
"padding: 5px;"));
    ...
    void retranslateUi(QMainWindow *UserInfo)
    {
        ...
        FilmLab->setText(QCoreApplication::translate("UserInfo", "<html><head/><body><p><span style=\" font-size:36pt; color:#e4d7be;\">Films</span></p></body></html>", nullptr));
        pushButton->setText(QCoreApplication::translate("UserInfo", "Search by genres", nullptr));
