...
"padding: 5px;"));
        ...
        HomeBFC = new QPushButton(widget_2);
        HomeBFC->setObjectName("HomeBFC");
        HomeBFC->setMinimumSize(QSize(0, 50));
        HomeBFC->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/housenormal.png);"));

        horizontalLayout->addWidget(HomeBFC);

        FilmBFC = new QPushButton(widget_2);
        FilmBFC->setObjectName("FilmBFC");
        FilmBFC->setMinimumSize(QSize(0, 50));
        FilmBFC->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/Films.png);"));

        horizontalLayout->addWidget(FilmBFC);

        TVShowsBFC = new QPushButton(widget_2);
        TVShowsBFC->setObjectName("TVShowsBFC");
        TVShowsBFC->setMinimumSize(QSize(0, 50));
        TVShowsBFC->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/TVShows.png);"));

        horizontalLayout->addWidget(TVShowsBFC);

        KidsBFC = new QPushButton(widget_2);
        KidsBFC->setObjectName("KidsBFC");
        KidsBFC->setMinimumSize(QSize(0, 50));
        KidsBFC->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/Kids.png);"));

        horizontalLayout->addWidget(KidsBFC);
        ...
        UserBFC = new QPushButton(widget_2);
        UserBFC->setObjectName("UserBFC");
        UserBFC->setMinimumSize(QSize(0, 50));
        UserBFC->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/profile-user.png);"));

        horizontalLayout->addWidget(UserBFC);
...
"padding: 5px;"));
    ...
    void retranslateUi(QMainWindow *FilmsCollection)
    {
        ...
        HomeBFC->setText(QString());
        FilmBFC->setText(QString());
        TVShowsBFC->setText(QString());
        KidsBFC->setText(QString());
        pushButton_15->setText(QCoreApplication::translate("FilmsCollection", "search", nullptr));
        UserBFC->setText(QString());
