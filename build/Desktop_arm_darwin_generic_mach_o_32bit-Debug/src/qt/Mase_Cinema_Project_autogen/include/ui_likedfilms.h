...
"padding: 5px;"));
        ...
        HomeBLF = new QPushButton(widget_2);
        HomeBLF->setObjectName("HomeBLF");
        HomeBLF->setMinimumSize(QSize(0, 50));
        HomeBLF->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/housenormal.png);"));

        horizontalLayout->addWidget(HomeBLF);

        FilmsBFI = new QPushButton(widget_2);
        ...
        horizontalLayout->addWidget(FilmsBFI);

        TVShowsBFL = new QPushButton(widget_2);
        TVShowsBFL->setObjectName("TVShowsBFL");
        TVShowsBFL->setMinimumSize(QSize(0, 50));
        TVShowsBFL->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/TVShows.png);"));

        horizontalLayout->addWidget(TVShowsBFL);

        KidsBFL = new QPushButton(widget_2);
        KidsBFL->setObjectName("KidsBFL");
        KidsBFL->setMinimumSize(QSize(0, 50));
        KidsBFL->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/Kids.png);"));

        horizontalLayout->addWidget(KidsBFL);
        ...
        UserBFL = new QPushButton(widget_2);
        UserBFL->setObjectName("UserBFL");
        UserBFL->setMinimumSize(QSize(0, 50));
        UserBFL->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/profile-user.png);"));

        horizontalLayout->addWidget(UserBFL);
...
"color: rgb(229, 217, 190);"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 800, 390));
