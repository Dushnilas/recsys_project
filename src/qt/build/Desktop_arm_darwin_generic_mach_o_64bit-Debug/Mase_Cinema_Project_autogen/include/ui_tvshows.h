...
public:
    ...
    QLabel *label;
    QPushButton *HomeButTV;
    QPushButton *FilmsButTV;
    QPushButton *TVShowsButTV;
    QPushButton *KidsButTV;
    QLineEdit *SearchEL;
    QPushButton *SerachButTV;
    QPushButton *UserButTV;
    QHBoxLayout *FilmLO;
    QLabel *FilmLab;
    QSpacerItem *horizontalSpacer;
    QPushButton *SearchByGTV;
    ...
    void setupUi(QMainWindow *TVShows)
    {
        ...
        TVShows->resize(962, 769);
        TVShows->setStyleSheet(QString::fromUtf8("background: qlineargradient(spread: pad, x1: 0, y1: 1, x2: 0, y2: 0, stop: 0 rgb(0, 0, 0), stop: 1 rgb(19, 21, 59));\n"
"color: white;"));
...
"padding: 5px;"));
        ...
        HomeButTV = new QPushButton(widget);
        HomeButTV->setObjectName("HomeButTV");
        HomeButTV->setMinimumSize(QSize(0, 50));
        HomeButTV->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/housenormal.png);"));

        horizontalLayout_2->addWidget(HomeButTV);

        FilmsButTV = new QPushButton(widget);
        FilmsButTV->setObjectName("FilmsButTV");
        FilmsButTV->setMinimumSize(QSize(0, 50));
        FilmsButTV->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/Films.png);"));

        horizontalLayout_2->addWidget(FilmsButTV);

        TVShowsButTV = new QPushButton(widget);
        TVShowsButTV->setObjectName("TVShowsButTV");
        TVShowsButTV->setMinimumSize(QSize(0, 50));
        TVShowsButTV->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/TVShows.png);"));

        horizontalLayout_2->addWidget(TVShowsButTV);

        KidsButTV = new QPushButton(widget);
        KidsButTV->setObjectName("KidsButTV");
        KidsButTV->setMinimumSize(QSize(0, 50));
        KidsButTV->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/Kids.png);"));

        horizontalLayout_2->addWidget(KidsButTV);
        ...
        SerachButTV = new QPushButton(widget);
        SerachButTV->setObjectName("SerachButTV");

        horizontalLayout_2->addWidget(SerachButTV);

        UserButTV = new QPushButton(widget);
        UserButTV->setObjectName("UserButTV");
        QSizePolicy sizePolicy(QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(UserButTV->sizePolicy().hasHeightForWidth());
        UserButTV->setSizePolicy(sizePolicy);
        UserButTV->setStyleSheet(QString::fromUtf8("border-image: url(:/rec/Pics/profile-user.png);"));

        horizontalLayout_2->addWidget(UserButTV);
...
""));
        ...
        SearchByGTV = new QPushButton(centralwidget);
        SearchByGTV->setObjectName("SearchByGTV");
        QSizePolicy sizePolicy1(QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Fixed);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(SearchByGTV->sizePolicy().hasHeightForWidth());
        SearchByGTV->setSizePolicy(sizePolicy1);
        SearchByGTV->setStyleSheet(QString::fromUtf8("background-color: rgba(255, 255, 255, 0);\n"
"color: rgb(0, 0, 0);\n"
"border: 4px solid rgb(229, 217, 190);\n"
"border-radius: 5px;\n"
"padding: 5px;\n"
...
"padding: 5px;"));
    ...
    void retranslateUi(QMainWindow *TVShows)
    {
        ...
        HomeButTV->setText(QString());
        FilmsButTV->setText(QString());
        TVShowsButTV->setText(QString());
        KidsButTV->setText(QString());
        SerachButTV->setText(QCoreApplication::translate("TVShows", "Serach", nullptr));
        UserButTV->setText(QString());
#if QT_CONFIG(tooltip)
        FilmLab->setToolTip(QCoreApplication::translate("TVShows", "<html><head/><body><p><span style=\" font-size:24pt; color:#e4d7be;\">Films</span></p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        FilmLab->setText(QCoreApplication::translate("TVShows", "<html><head/><body><p><span style=\" font-size:36pt; color:#e4d7be;\">TV Shows</span></p></body></html>", nullptr));
        SearchByGTV->setText(QCoreApplication::translate("TVShows", "Search by genres", nullptr));
        Top100Lab->setText(QCoreApplication::translate("TVShows", "<html><head/><body><p><span style=\" font-size:18pt; color:#e4d7be;\">Top 100</span></p></body></html>", nullptr));
        pushButton_8->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        pushButton_11->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        label_6->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        label_3->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        pushButton_7->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        label_5->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        pushButton_9->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        label_2->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        pushButton_6->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        pushButton_10->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        label_4->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        label_7->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        TopComLab->setText(QCoreApplication::translate("TVShows", "<html><head/><body><p><span style=\" font-size:18pt; color:#e4d7be;\">Top Comedies</span></p></body></html>", nullptr));
        pushButton_17->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        label_11->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        label_13->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        pushButton_14->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        label_8->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        pushButton_16->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        label_9->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        pushButton_12->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        pushButton_13->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        label_10->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        pushButton_15->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        label_12->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        TopFantLab->setText(QCoreApplication::translate("TVShows", "<html><head/><body><p><span style=\" font-size:18pt; color:#e4d7be;\">Top Fantasy</span></p></body></html>", nullptr));
        label_17->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        pushButton_22->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        label_18->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        pushButton_20->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        label_20->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        label_19->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        label_16->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
        pushButton_18->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        pushButton_19->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        pushButton_23->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        pushButton_21->setText(QCoreApplication::translate("TVShows", "PushButton", nullptr));
        label_15->setText(QCoreApplication::translate("TVShows", "TextLabel", nullptr));
    } // retranslateUi
